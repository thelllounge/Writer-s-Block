...
//add seasonal class to the body to change all color variables to seasonal options
 ...
 //add seasonal options to the prompt arrays   
      Papa.parse('https://docs.google.com/spreadsheets/d/e/2PACX-1vT3pJgyMkUFc6wet1PPnyJ4AquHwmvP0NYb6rx5z1N59TngIUnqP9N5ZGLJpIGiQlF3ItQwtn5kEdYc/pub?gid=377186994&single=true&output=csv', {
  download: true,
  header: true,
  error: undefined,
  complete: function(results) {
